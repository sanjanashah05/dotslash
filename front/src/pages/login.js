      ...
      <div className="w-full max-w-md p-8 bg-transparent rounded-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input type="text" className="w-full p-2 border rounded-md" value={username} onChange={(e) => setUsername(e.target.value)} required />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" className="w-full p-2 border rounded-md" placeholder="Enter CAPTCHA" value={captchaInput} onChange={(e) => setCaptchaInput(e.target.value)} required />
          </div>
